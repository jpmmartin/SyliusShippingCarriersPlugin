...
namespace JpmMartin\SyliusShippingCarriersPlugin\Controller;
...
final class GreetingController extends AbstractController
{
    ...
    {
        return $this->render(
            '@JpmMartinSyliusShippingCarriersPlugin/shop/greeting/static.html.twig',
    ...
    {
        return $this->render(
            '@JpmMartinSyliusShippingCarriersPlugin/shop/greeting/dynamic.html.twig',
            ['greeting' => $this->getGreeting($name)],
        );
    }
