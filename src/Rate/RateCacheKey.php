 ...
 * session, so two buyers sending the same packages to the same place share the rates.
 *
...
final class RateCacheKey
{
     ...
     */
    public static function for(string $carrier, array $carrierConfiguration, RateRequest $request, string $currencyCode): string
    {
