 ...
 * business (CA-48). The field belongs to the whole form, not to the shipping address: a channel that does not
 * ask for a separate shipping address hides that block and copies the billing address into it (D-28).
 */
