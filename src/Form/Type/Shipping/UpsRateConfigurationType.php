 ...
 * @internal
 */
final class UpsRateConfigurationType extends AbstractType
{
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefault('carrier', CarrierCredentialsInterface::CARRIER_UPS);
    }
    ...
    {
        return 'jpmmartin_carrier_ups_rate_configuration';
    }
}
